import { imgPreview } from './form-elements.js';
...
const onSliderUpdate = () => {
  ...
  if (isDefault()) {
    imgPreview.style.filter = DEFAULT_EFFECT.filter;
  } else {
    imgPreview.style.filter = `${currentEffect.filter}(${sliderValue}${currentEffect.unit})`;
  }
};
